...
def check_speed_increase():
    global next_milestone,SPEED
    if SCORE_COINS>=next_milestone:
        SPEED+=0.5
        next_milestone+=30
...
while True:
    ...
    DISPLAYSURF.blit(score_coins,(375,10))
    ...
    if pygame.sprite.collide_rect(P1, C1): 
        pygame.mixer.Sound('recieve.mp3').play()
        SCORE_COINS+=random.randint(1,11)
